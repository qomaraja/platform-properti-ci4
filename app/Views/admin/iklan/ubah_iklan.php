  ...
  <section class="content">
    <div class="container-fluid">
      <div class="card card-primary">
        ...
        <form action="<?= 'iklan/update-iklan/' . $iklan['iklan_id']; ?>" method="post" enctype="multipart/form-data">
          <?= csrf_field(); ?>
          <input type="hidden" name="imgLama" value="<?= $iklan['iklan_img']; ?>">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="col-3">
                      <div class="img-preview" id="img-preview">
                        <img src="<?= 'visit/img/iklan/' . $iklan['iklan_img']; ?>" class="img-thumbnail preview-image" alt="Preview" />
                      </div>
                    </div>
                    <div class="col-9">
                      <div class="custom-file">
                        <input type="file" class="custom-file-input file-input" id="customFile" name="iklan_img" onchange="previewImg()" />
                        <label class="custom-file-label" for="customFile"><?= $iklan['iklan_img']; ?></label>
                      </div>
                    </div>
                  </div>
                </div>
